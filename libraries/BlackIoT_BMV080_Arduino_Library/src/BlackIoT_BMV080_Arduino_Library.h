/******************************************************************************
 * @file BlackIoT_BMV080_Arduino_Library.h
 * 
...
#define BMV080_MODE_CONTINUOUS 0
#define BMV080_MODE_DUTY_CYCLE 1

class BMV080SPI
{
  public:
    /// @brief Default constructor
    //BMV080SPI(SPISettings spiSettings = SPISettings(100000, MSBFIRST, SPI_MODE0));
    BMV080SPI(void): spi_bmv080(nullptr) {}
    /**
     ...
     *
     * the function use the SPI pin defined on the variant.
     * 
     * @return Status code:
     *         - true: Success
     ...
     * @see open()
     */
    bool begin(SPIClass &spiPort = SPI);
  ...
  protected:
    SPIClass *spi_bmv080;
    static SPISettings spi_bmv080_Settings;
};