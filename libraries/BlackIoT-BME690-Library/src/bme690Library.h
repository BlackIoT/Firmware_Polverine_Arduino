...
public:
     ...
     * @param idleTask : Delay or Idle function
     */
    void begin(uint8_t i2cAddr = BME69X_I2C_ADDR_LOW, TwoWire &i2c = Wire, bme69x_delay_us_fptr_t idleTask = bme69xDelayUs);
     ...
     * @return Operation mode : BME68X_SLEEP_MODE, BME69X_FORCED_MODE, BME69X_PARALLEL_MODE, BME69X_SEQUENTIAL_MODE
     */
